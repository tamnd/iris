...
This crate contains unsafe code and almost nothing else in the workspace does. `iris-vm` has one call, which is loading machine code it compiled earlier, and every other crate carries `#![forbid(unsafe_code)]`.
